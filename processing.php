...
<div class="popup-wrapper animated fadeIn" id="get_gift">
...
Thank your for joining this Lucky Crate - End Season event.
<br>
<br>
...
<br>
<button type="button" class="tengah" onclick="location.href='/';">Logout</button>
</div>
</div> <!--- popup gift --->
</div> <!--- popup --->
